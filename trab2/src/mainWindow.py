...
class mainWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # UI - General
        self.setWindowTitle('Raspberry Pi - Antenna')
        ...
        ##### Additional Windows
        self.infoWindow = commandWindow(self.intCommandsDescription, self.mixCommandsDescription)
